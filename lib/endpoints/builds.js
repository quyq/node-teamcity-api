...
function getBuildsByBuildTypeWithDimensions() {
  return new APIEndpoint()
      .get()
      .uri("builds/?locator=buildType:({locator}),{dimensions},defaultFilter:false{fields}")
      .pureJson()
      .locator({name: "locator", validator: buildTypeLocator})
      .locator({name: "dimensions", validator: buildTypeLocator})
      .locator({name: "fields", validator: buildTypeLocator})
      ;
}
...
function getBuildsByProjectWithDimensions() {
  return new APIEndpoint()
      .get()
      .uri("builds/?locator={project},{dimensions},defaultFilter:false{fields}")
      .pureJson()
