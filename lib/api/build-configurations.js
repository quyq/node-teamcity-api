...
BuildConfigurations.prototype.getByTemplate = function (locator) {
  return this._request.execute(buildConfigurationEndpoints.getBuildConfigurationByTemplate, {locator: locator});
};
