...
Builds.prototype.getByBuildTypeWithDimensions = function (locator, dimensions, fields) {
  return this._request.execute(buildsEndpoints.getBuildsByBuildTypeWithDimensions, {locator: locator, dimensions: dimensions, fields: fields});
};
