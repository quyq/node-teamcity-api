...
TeamCityAPI.prototype.queryTxt = function (parameters) {
  return this._request.execute(hostEndpoints.queryTxt, parameters);
};

TeamCityAPI.prototype.queryXml = function (parameters) {
  return this._request.execute(hostEndpoints.queryXml, parameters);
};

TeamCityAPI.prototype.queryJson = function (parameters) {
  return this._request.execute(hostEndpoints.queryJson, parameters);
};

TeamCityAPI.prototype.postXml = function (parameters) {
  return this._request.execute(hostEndpoints.postXml, parameters);
};

TeamCityAPI.prototype.postJson = function (parameters) {
  return this._request.execute(hostEndpoints.postJson, parameters);
};
///////////////////////////////////////////////////////////
